    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Bonding and white fillings</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}><b>Bonding</b> is a cosmetic dental procedure in which a tooth-colored composite resin is applied to the surface of a tooth and then hardened with a special light. <br></br>The resin is shaped and polished to match the surrounding teeth, and is used to repair chips, cracks, and gaps in the teeth. <br></br>Bonding can also be used to change the shape or color of the teeth, or to protect the roots of teeth that have been exposed due to receding gums.
<br></br><br></br>
<b>White fillings</b>, also known as composite fillings, are used to fill cavities in the teeth. <br></br>They are made from a mixture of fine glass or quartz particles and a resin, and are designed to match the color of the surrounding teeth.<br></br> White fillings are an alternative to traditional silver amalgam fillings, and are often preferred because they are more aesthetically pleasing and blend in with the natural color of the teeth.
<br></br><br></br>
Both bonding and white fillings are relatively simple procedures that can be completed in a single visit to the dentist. They are both effective ways to repair and restore teeth, and can help to improve the appearance of the smile.</p>
