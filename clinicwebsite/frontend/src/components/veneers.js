...
import {Button, Toast, ToastHeader, ToastBody, Carousel, CarouselItem, CarouselControl, CarouselIndicators, CarouselCaption, Fade, AccordionItem, AccordionHeader, UncontrolledAccordion} from "reactstrap";
    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Veneers</NavbarBrand>
                        <NavbarToggler onClick={this.toggle} />
                            ...
                            <p style={{padding:"20px", fontSize:"20px"}}>Veneers are thin, custom-made shells of porcelain or composite material that are designed to cover the front surface of the teeth. They are often used to improve the appearance of the teeth and smile and can be used to address a variety of cosmetic concerns, such as stained, chipped, crooked, or misshapen teeth.</p>
                           <Accordion>
      
      <Accordion.Item eventKey="1" >
        <Accordion.Header style={{paddingLeft:"20px", fontColor:"white"}}>Treatment Procedure</Accordion.Header>
        <Accordion.Body>
        <p style={{padding:"20px", fontSize:"20px"}}>To place veneers, the dental professional will first prepare the teeth by removing a small amount of enamel from the front surface of the teeth. This is necessary to create space for the veneers and ensure that they fit properly. The dental professional will then take impressions of the teeth and use them to create custom-made veneers. Once the veneers are ready, the dental professional will place them on the teeth and make any necessary adjustments to ensure a proper fit.</p>
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="2" >
        <Accordion.Header style={{paddingLeft:"20px", fontColor:"white"}}>How to care for my veneers?</Accordion.Header>
        <Accordion.Body>
        <p style={{padding:"20px", fontSize:"20px"}}>Veneers are generally easy to care for and can be maintained with regular brushing and flossing. They are durable and can last for many years with proper care. However, they are not indestructible and can be damaged by biting on hard objects or grinding the teeth.</p>
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
...
Overall, veneers are a popular and effective option for improving the appearance of the teeth and smile. If you are considering veneers, it is important to consult with a dental professional to determine if this treatment option is right for you.
