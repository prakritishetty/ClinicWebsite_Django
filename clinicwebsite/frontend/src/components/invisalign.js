...
const Invisalign = () => {
  return (
    <TreatmentLayout
      ...
      whenToConsider={[
        "You have severely crowded or overlapping teeth.",
        "There are noticeable gaps between your teeth.",
        "You suffer from deep bite or crossbite issues.",
        "You want a straighter smile without the aesthetic impact of metal braces.",
        "You have forward placed teeth which prevent your lips from closing against each other."
      ]}
      faqs={[
