    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Teeth Aligners</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}>Teeth aligners are a type of orthodontic treatment that are used to straighten teeth and improve the alignment of the bite. <br></br><br></br>
Teeth aligners can be used to correct a wide range of orthodontic issues, including crowded teeth, misaligned teeth, and improper bites. They are a popular alternative to traditional metal braces because they are more discreet and easier to care for.
<br></br><br></br>
<table>
        <tr>
          <th style={{borderBottom: "1px solid black", borderRight:"1px solid black", padding:"30px"}}>Traditional Aligners</th>
          <th style={{borderBottom: "1px solid black", padding:"30px"}}>Invisible Aligners</th>
          
        </tr>

            <tr >
              <td style={{ borderRight:"1px solid black", padding:"30px"}}>Made of a hard plastic material and are visible when worn</td>
              <td style={{padding:"30px"}}>Made of a clear, flexible plastic material and are nearly invisible when worn.</td>
...
<br></br><br></br>
To use teeth aligners, the patient will receive a series of aligners that are designed to gradually move the teeth into their proper position. The patient will wear each aligner for a set period of time (usually two to four weeks) before moving on to the next aligner in the series. Teeth aligners are generally worn for 20 to 22 hours per day and should be removed only when eating, drinking, brushing, or flossing.

<br></br><br></br>
Overall, teeth aligners are a safe and effective option for straightening teeth and improving the alignment of the bite. If you are considering teeth aligners, it is important to consult with a dental professional to determine if this treatment option is right for you.</p>
