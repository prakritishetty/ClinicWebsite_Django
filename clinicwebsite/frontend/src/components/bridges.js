    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Bridges</NavbarBrand>
...
<div>
    ...
    <Accordion>
      ...
      <Accordion.Item eventKey="1" >
        <Accordion.Header style={{paddingLeft:"20px", fontColor:"white"}}>What is a bridge?</Accordion.Header>
        <Accordion.Body>
        <p style={{padding:"20px", fontSize:"20px"}}>A tooth bridge is a fixed dental appliance that is used to replace one or more missing teeth. It consists of one or more artificial teeth, known as pontics, that are attached to crowns on either side. The crowns are placed over the teeth adjacent to the gap left by the missing tooth or teeth, and the pontic is suspended in the gap, filling the space and restoring function to the mouth..</p>
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="2" >
        <Accordion.Header style={{paddingLeft:"20px", fontColor:"white"}}>Bridge Materials</Accordion.Header>
        <Accordion.Body>
        <p style={{padding:"20px", fontSize:"20px"}}>Tooth bridges can be made from a variety of materials, including porcelain, ceramic, or gold. They are custom-made to fit the patient's mouth and are usually cemented into place, although they can also be secured using dental implants.</p>
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
<br></br>

Tooth bridges are a permanent solution for missing teeth, and can help to improve the appearance of the smile, restore proper function to the mouth, and prevent the remaining teeth from shifting out of position. They are typically easier to care for than dentures, and can last for many years with proper care.</p>
