    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Bone Grafts</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}> A tooth bone graft is a surgical procedure in which bone tissue is added to the jawbone in order to repair or rebuild it. This type of procedure may be necessary if the jawbone has been damaged or has deteriorated due to periodontal disease, trauma, or tooth loss.
<br></br><br></br>
<hr></hr>
Tooth bone grafts can be used to:
<br></br><br></br>
<ul><li>Replace bone that has been lost due to periodontal disease or trauma</li><li>Repair bone that has been damaged by infection or injury</li>
<li>
Strengthen the jawbone in preparation for dental implant surgery</li>
</ul>
<hr></hr>
 

There are several different types of bone grafting materials that can be used, including synthetic bone substitutes, donor bone tissue, and the patient's own bone tissue. The type of material used will depend on the specific needs of the patient and the location of the graft.
<br></br><br></br>
<hr></hr>
 The recovery time after a tooth bone graft will vary depending on the extent of the procedure and the patient's individual healing process.</p>
