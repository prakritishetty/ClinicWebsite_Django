    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}} >Surgical Services</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}>Surgical dentistry is the branch that deals with cases related to XYZ</p>
<Accordion  flush >
  <Navbar>
      <Accordion.Item eventKey="0" style={{padding:"20px"}}> 
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Implants</Accordion.Header>
      ...
      <Accordion.Item eventKey="1"  style={{  padding:"20px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Extractions</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="2"  style={{ padding:"20px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Root Canal</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="3"  style={{ padding:"20px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Bone Graft</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="5"  style={{ padding:"10px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Bridges</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="4"  style={{ padding:"30px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Implant-supported dentures</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="6"  style={{ padding:"20px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Over dentures</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="6"  style={{ padding:"20px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Same day implants</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
