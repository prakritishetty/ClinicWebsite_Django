    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Night Guards</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}>
      <hr></hr>A nightguard is a dental appliance that is worn over the teeth at night to protect them from grinding or clenching. It is also known as a dental splint or occlusal guard
<br></br><br></br>
<hr></hr>
Nightguards are often used to treat <b>bruxism</b>, a condition in which the person grinds or clenches their teeth while sleeping. Bruxism can cause a number of problems, including tooth sensitivity, tooth damage, and jaw pain. A nightguard can help protect the teeth from the damaging effects of grinding and clenching, reducing the risk of tooth sensitivity and damage.
<br></br><br></br>
<hr></hr>
Nightguards are typically made of a hard plastic material and are custom-fitted to the person's teeth. They are worn over the upper or lower teeth and are held in place by suction or a small amount of saliva. Nightguards are generally easy to use and comfortable to wear.
<br></br><br></br>
<hr></hr>
Overall, nightguards are a useful tool for protecting the teeth from grinding and clenching and can help prevent tooth sensitivity and damage. If you are experiencing symptoms of bruxism, such as tooth sensitivity or jaw pain, it is important to consult with a dental professional to determine if a nightguard is right for you.<hr></hr></p>
