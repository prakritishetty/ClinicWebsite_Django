    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Emergency Care in Dentistry</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}>Emergency dental care is essential for addressing unexpected dental issues that require immediate attention, such as a toothache, a broken tooth, or a lost filling. These types of issues can be very painful and can significantly impact your oral health if not treated promptly.
<br></br><br></br>
If you are experiencing a dental emergency, it is important to seek treatment as soon as possible. You can contact your dentist's office to determine if they are able to see you for an emergency appointment. If you are unable to reach your dentist or if they are unavailable, you may need to go to an emergency dental clinic or the emergency department of a hospital.
<br></br><br></br>
In some cases, emergency dental care may involve addressing the immediate problem, such as extracting a tooth or providing pain relief, and then scheduling a follow-up appointment for further treatment.
<br></br><br></br>
It is important to follow the instructions provided by your dental professional for caring for your teeth and mouth after an emergency procedure. This may include taking medications as prescribed, avoiding certain foods or activities, and practicing good oral hygiene to help prevent further complications.</p>
