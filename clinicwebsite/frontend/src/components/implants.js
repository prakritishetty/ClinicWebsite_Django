    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Implants</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}>Tooth implants are a type of dental restoration that involves the placement of a metal post or frame into the jawbone to serve as a replacement for the root of a missing tooth. The post or frame is usually made of titanium or a titanium alloy, which is biocompatible and can integrate with the bone tissue over time. Once the implant has integrated with the bone, a crown or other type of artificial tooth can be attached to the top of the implant.
    <img src="https://teethq.com/wp-content/uploads/2021/03/dental-implant-3.gif" align="right" height="500px"/>
<br></br><br></br>
Tooth implants are a popular option for replacing missing teeth because they offer a number of benefits. 
<ul><li>They can help restore the appearance and function of the missing tooth, allowing you to eat and speak normally. </li><li>They also help maintain the structure of the jawbone and prevent tooth shifting, which can occur when a tooth is missing.</li>
</ul>

<br></br><br></br>
Overall, tooth implants are a safe and effective way to replace missing teeth and can help restore the appearance and function of your mouth. If you are considering a tooth implant, it is important to consult with a dental professional to determine if this treatment option is right for you.</p>
