    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Full  Mouth  Rehabilitation</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}>Full mouth rehabilitation, also known as full mouth reconstruction or full mouth restoration, is a type of dental treatment that involves repairing or replacing all of the teeth in the upper and lower jaws. This type of treatment is typically recommended for patients who have a significant amount of dental damage or are experiencing multiple oral health issues.
<br></br><br></br>

Full mouth rehabilitation can be a complex and lengthy process that may involve several different dental procedures. The specific treatment plan will depend on the individual needs of the patient, but may include:
<br></br><br></br>
<div class="shadow">
                <img src="https://i.pinimg.com/474x/0a/92/fa/0a92fa2873e20d318bf7dbe1ef1e47e4.jpg" align="left" style={{margin:"10px", padding:"20px" }} height="300px"/>
        </div>
<b>Dental exams and cleanings:</b> These are performed to remove plaque and tartar from the teeth and to identify any potential dental problems.<br></br>
<b>Tooth extractions:</b> If a tooth is severely damaged or decayed, it may need to be removed.<br></br>
<b>Fillings:</b> If a tooth has a cavity, a filling may be used to repair it.<br></br>
<b>Crowns and bridges:</b> These are used to restore damaged or missing teeth.<br></br>
<b>Orthodontic treatment:</b> This may include braces or other appliances to straighten the teeth.<br></br>
<b>Dental implants:</b> These are used to replace missing teeth.<br></br>
In some cases, full mouth rehabilitation may also involve cosmetic procedures, such as teeth whitening or veneers, to improve the appearance of the teeth.
<br></br><br></br>
Full mouth rehabilitation can help restore the function and appearance of the teeth, and can significantly improve a patient's oral health and quality of life. It is important to work closely with a dental professional to develop a treatment plan that meets your individual needs and goals.</p>
