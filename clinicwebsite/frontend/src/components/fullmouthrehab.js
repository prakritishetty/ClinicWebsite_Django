  ...
  return (
    <TreatmentLayout
      ...
      faqs={[
        ...
        { q: "How long does full mouth rehabilitation take?", a: "Because it involves multiple complex procedures, treatment can take a few weeks to complete. We pace the treatments to ensure optimal healing." },
        { q: "Is it affordable?", a: "We provide a detailed treatment plan and breakdown of costs beforehand, so you know exactly what to expect before anything begins." }
      ]}
    />
  );
};
