    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Crowns</NavbarBrand>
...
<div>
    ...
    A tooth crown, also known as a dental crown, is a type of dental restoration that covers or encases the entire visible surface of a tooth. Crowns are typically used to restore the function and appearance of teeth that have been damaged or are decayed to the point where a filling is no longer sufficient. Crowns can also be used to improve the appearance of a tooth by changing its shape or color.<br></br><br></br>
    <Accordion>
      
      <Accordion.Item eventKey="1" >
        <Accordion.Header style={{paddingLeft:"20px", fontColor:"white"}}>Which crown should I choose</Accordion.Header>
        <Accordion.Body>
        <p style={{padding:"20px", fontSize:"20px"}}>There are several types of crowns available, including porcelain, ceramic, and gold crowns. 
        <br></br>Porcelain and ceramic crowns are popular because they closely match the color and translucency of natural teeth, but they may be more prone to chipping or breaking than gold crowns. Gold crowns are more durable but are less natural-looking.</p>
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="2" >
        <Accordion.Header style={{paddingLeft:"20px", fontColor:"white"}}>Treatment Procedure</Accordion.Header>
        <Accordion.Body>
        <p style={{padding:"20px", fontSize:"20px"}}>To place a crown, a dentist will first prepare the tooth by removing any decay or damage and shaping the surface to ensure a good fit for the crown. Next, an impression of the tooth is taken and used to create a custom-made crown. The crown is then cemented onto the prepared tooth.</p>
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
<br></br>
It is important to brush and floss your teeth and visit the dentist regularly to keep your crowns in good condition. Crowns can last for many years with proper care, but they may need to be replaced eventually due to wear or damage.</p>
