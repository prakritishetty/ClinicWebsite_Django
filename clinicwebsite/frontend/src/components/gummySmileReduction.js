    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Gummy Smile Reduction</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}>A gummy smile is a term used to describe a smile that reveals too much gum tissue when the lips are parted. This can be caused by a variety of factors, including the shape of the teeth, the length of the teeth, or the position of the jaw. A gummy smile can affect the appearance of the teeth and may make a person feel self-conscious about their smile.
    <img src="https://ih1.redbubble.net/image.780195444.4073/st,small,507x507-pad,600x600,f8f8f8.jpg" align="right" height="500px" style={{borderRadius:"100px"}}/>
<br></br><br></br>
There are several treatment options available for reducing a gummy smile. These may include:
<br></br><br></br>
<b>Orthodontic treatment: </b> In some cases, orthodontic treatment, such as braces, can be used to move the teeth into a more aesthetically pleasing position and expose more of the tooth surface.<br></br>
<b>Laser gum contouring: </b> This procedure involves using a laser to remove excess gum tissue and expose more of the tooth surface.<br></br>
<b>Crown lengthening: </b> This procedure involves removing a small amount of gum tissue and bone to expose more of the tooth.<br></br>
<b>Porcelain veneers: </b> Veneers are thin, custom-made shells that are placed over the front surface of the teeth. They can be used to cover up a gummy smile and improve the appearance of the teeth.
<br></br><br></br>
The best treatment option for reducing a gummy smile will depend on the underlying cause of the problem and the individual needs and goals of the patient. It is important to work closely with a dental professional to determine the most appropriate treatment plan.
</p>
