    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Implant Supported Dentures</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}>Implant-supported dentures are a type of dental restoration that involves the placement of dental implants in the jawbone to support a full or partial denture. A full denture is a removable appliance that replaces all of the teeth in the upper or lower jaw, while a partial denture is a removable appliance that replaces some of the teeth in the jaw.
<br></br><br></br>
Implant-supported dentures offer several benefits compared to traditional dentures. They are more stable and secure than traditional dentures, which can slip or move around in the mouth. Implant-supported dentures also help preserve the structure of the jawbone, as the implants stimulate the bone tissue and prevent bone loss. In addition, implant-supported dentures can improve the function of the denture, allowing you to chew and speak more easily.
<br></br><br></br>
To place implant-supported dentures, a dental specialist will first place dental implants into the jawbone. The implants are typically made of titanium or a titanium alloy and are designed to integrate with the bone tissue over time. After the implants have integrated with the bone, the denture can be attached to the implants using a variety of mechanisms, such as ball and socket attachments or bar and clip attachments.
<br></br><br></br>
Overall, implant-supported dentures are a more stable and secure option for replacing missing teeth compared to traditional dentures. They can improve the appearance, function, and stability of the denture and help preserve the structure of the jawbone. If you are considering implant-supported dentures, it is important to consult with a dental professional to determine if this treatment option is right for you.</p>
