...
const Extractions = () => {
  return (
    <TreatmentLayout
      ...
      offerings={[
        { title: "Painless Procedure", desc: "We use effective local anesthetics and offer sedation options to ensure a pain-free, relaxed experience." },
      ...
      faqs={[
        ...
        { q: "What should I eat after an extraction?", a: "Stick to soft foods like yogurt, pudding, applesauce, and mashed potatoes for the first few days. Avoid using a straw, as the suction can dislodge the blood clot." }
      ]}
    />
  );
};
