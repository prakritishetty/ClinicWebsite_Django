    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Extractions</NavbarBrand>
...
<div style={{padding:"30px"}}>
          ...
          <img src={gums} height="500px" style={{pointerEvents:"none", position: "absolute", width: "500px", height: "700px",  zIndex: -1, opacity:0.2}}/>
          <img src={fallingtooth} className="circle1 moveCircle" height="200px" width="500px" style={{pointerEvents:"none", position: "absolute", width: "100%", height: "700px",  zIndex: -1, opacity:0.2}}></img>
        
    
        
    <p style={{padding:"20px", fontSize:"20px"}}>A tooth extraction is a procedure in which a tooth is removed from the mouth. Tooth extractions are typically performed by a dentist or an oral surgeon.
<br></br><br></br>
There are several reasons why a tooth may need to be extracted. One common reason is if the tooth is severely damaged or decayed and cannot be repaired. Other reasons for tooth extraction may include:
<br></br><br></br>
<b>Crowded mouth:</b> If there is not enough room in the mouth for all of the teeth, some may need to be removed to make room for the others.<br></br>
<b>Orthodontic treatment:</b> In some cases, teeth may need to be removed to make room for orthodontic treatment, such as braces.<br></br>
<b>Infection:</b> If a tooth is infected and cannot be saved, it may need to be extracted to prevent the infection from spreading to other teeth or to other parts of the body.

<table>
        <tr>
          <th style={{borderBottom: "1px solid black", borderRight:"1px solid black", padding:"30px"}}>Simple Extractions</th>
          <th style={{borderBottom: "1px solid black", padding:"30px"}}>Surgical Extractions</th>
          
        </tr>

            <tr >
              <td style={{ borderRight:"1px solid black", padding:"30px"}}>Performed on a tooth that is visible in the mouth and can be removed with forceps</td>
              <td style={{padding:"30px"}}>More complex procedure that  may be necessary for teeth that are broken off at the gum line or for teeth that have not erupted through the gums. This type of extraction may require the use of local anesthesia, intravenous (IV) sedation, or general anesthesia to numb the area and make the procedure more comfortable.</td>
...
<br></br><br></br>
After a tooth extraction, it is important to follow the instructions provided by your dental professional for caring for the extraction site and managing any discomfort. This may include taking prescribed medications, avoiding certain activities or foods, and practicing good oral hygiene.</p>
