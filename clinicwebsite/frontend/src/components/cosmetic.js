    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}} >Cosmetic Services</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px"}}>Cosmetic dentistry is the branch that deals with cases related to XYZ</p>
<Accordion  flush >
  <Navbar>
      <Accordion.Item eventKey="0" style={{padding:"20px"}}> 
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>InvisAlign</Accordion.Header>
      ...
      <Accordion.Item eventKey="1"  style={{  padding:"20px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Teeth Whitening</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="2"  style={{ padding:"20px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Bonding</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="3"  style={{ padding:"20px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Veneers</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="4"  style={{ padding:"30px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Smile Makeover</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="5"  style={{ padding:"10px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Gummy Smile Reduction</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="6"  style={{ padding:"20px"}}>
        <Accordion.Header style={{fontFamily:"Verdana", background:"#808080"}}>Full Mouth Rehabilitation</Accordion.Header>
        <Accordion.Body style={{background:"#DCDCDC" , padding:"20px"}}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
