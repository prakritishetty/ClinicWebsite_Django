...
const SmileMakeover = () => {
  return (
    <TreatmentLayout
      ...
      intro="A smile makeover is a completely customized treatment plan combining multiple cosmetic and restorative dental procedures to dramatically enhance the appearance of your smile. We consider your facial appearance, skin tone, hair color, and tooth shape to design a smile that is uniquely yours."
      offerings={[
      ...
      whenToConsider={[
        ...
        "You have multiple aesthetic issues (e.g., both discoloration and chipped teeth).",
        "You are preparing for a major life event like a wedding or a new career.",
        "You want to look younger and more vibrant."
      ]}
      faqs={[
        { q: "What procedures are included in a smile makeover?", a: "It varies by patient. A plan may include teeth whitening, porcelain veneers, orthodontics (Invisalign), dental implants, or gum contouring." },
