    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Smile Makeover</NavbarBrand>
...
<div style={{display: "inline-block",  overflow: "hidden",  position: "relative",  width: "100%"}}>
  <img src="https://www.idlehearts.com/images/smileit-makes-people-wonder-what-youre-up-to.jpg" style={{pointerEvents:"none", position: "absolute", width: "100%", height: "700px",  zIndex: -1, opacity:0.2}}/>
    <p style={{padding:"20px", fontSize:"20px"}}>A smile makeover is a comprehensive dental treatment plan that is designed to improve the appearance of the smile. It can involve a variety of procedures, such as teeth whitening, veneers, braces, and gum contouring, depending on the specific goals and needs of the patient.
    <br></br><br></br>
    <b>Ask yourself if a smile makeover is for you</b><br></br>   
Smile makeovers are often sought by people who are unhappy with the appearance of their teeth or smile. They may have issues such as stained, chipped, crooked, or misshapen teeth, or they may simply want to improve the overall aesthetics of their smile. A smile makeover can help address these concerns and improve the overall appearance of the teeth and smile.
<br></br><br></br>
<b>Treatment Plan</b><br></br>
To determine the best treatment plan for a smile makeover, the dental professional will perform a thorough examination of the teeth and mouth, including taking x-rays and making impressions of the teeth. The dental professional will then work with the patient to create a customized treatment plan that is tailored to the patient's specific goals and needs.
<br></br><br></br>
Overall, a smile makeover can be a highly effective way to improve the appearance of the teeth and smile and boost self-confidence. If you are considering a smile makeover, it is important to consult with a dental professional to determine the best treatment options for you.</p>
