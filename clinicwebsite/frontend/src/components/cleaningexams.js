...
import {clean} from "./cleaning.png"
    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Tooth Cleaning and Examinations</NavbarBrand>
...
<div>
    ...
    {/* <img src={clean} height="500px" style={{pointerEvents:"none", position: "absolute", width: "500px", height: "700px",  zIndex: -1, opacity:0.2}}/>
     */}
     <hr></hr>
      Tooth cleaning and examination are important parts of maintaining good oral hygiene and overall health.
Tooth cleaning involves the removal of plaque and tartar, which are sticky films of bacteria that form on the teeth and can cause tooth decay and gum disease. Plaque can be removed by brushing and flossing, while tartar can only be removed by a dental professional.<br></br><br></br>
<hr></hr>
During a dental examination, a dental professional will examine your teeth and gums for any signs of problems, such as tooth decay, gum disease, or oral cancer. They may use tools such as a mirror, probe, and x-rays to get a closer look at your teeth and mouth.
<br></br><br></br>
<hr></hr>
It's generally recommended to have your teeth cleaned and examined by a dental professional at least twice a year, or more frequently if you have gum disease or other oral health issues. This can help catch problems early and prevent them from getting worse.<br></br><br></br>
<hr></hr>
In addition to regular cleanings and exams, it's important to brush and floss your teeth daily to remove plaque and prevent tooth decay and gum disease. Using fluoride toothpaste and mouthwash can also help to strengthen your teeth and protect against tooth decay.</p>
