    ...
    render()
    {
        ...
        <div>
                    <Navbar color="secondary" style={{color:"white"}}>
                        <NavbarBrand href="/" style={{color:"white", fontFamily:"Arizonia", fontSize:"35px"}}>Dentures</NavbarBrand>
...
<div>
    <p style={{padding:"20px", fontSize:"20px" ,backgroundImage: `linear-gradient(to right, white , yellow)`}}>Dentures are removable artificial teeth that are used to replace missing teeth. They are made of acrylic resin or a combination of acrylic resin and other materials, and are custom-made to fit the patient's mouth. There are two main types of dentures: full dentures and partial dentures.
    <hr></hr>
<br></br><br></br>
<ul>
Full dentures are used to replace all of the teeth in the upper or lower jaw, or in both jaws. They are held in place by suction or by a small amount of natural saliva, and can be removed by the patient for cleaning.

<br></br><br></br>
Partial dentures are used to replace some missing teeth, and are held in place by natural teeth or dental implants. They can be removed by the patient for cleaning, and can be made from acrylic resin, metal, or a combination of both.
</ul>
<hr></hr>
<br></br><br></br>
Dentures can help to restore the appearance and function of the mouth, and can improve the patient's ability to eat and speak. They are typically easier to care for than fixed dental appliances, such as bridges, and can be removed for cleaning and soaking.
<hr></hr>
<br></br><br></br>
It is important to clean and care for dentures properly in order to maintain good oral hygiene and extend their lifespan. This includes brushing them daily, storing them in a safe place when they are not being worn, and soaking them in a special solution when they are not in use. It is also important to visit the dentist regularly for checkups and adjustments, as dentures may need to be relined or replaced over time.</p>
